    ...
    <table class="table table-striped table-hover">
        <thead class="table-dark"> <!-- Encabezado de la tabla con fondo oscuro -->
            <tr>
                ...
                <th scope="col">Direccion</th> <!-- Corregimos la ortografía -->
                <th scope="col">telefono</th>
                <th scope="col">Correo_electronico</th> <!-- Espacios entre palabras -->
                                        ...
                                        <div class="modal-body">
                                            <form action="edit.php?id=<?= $row[0] ?>" method="post">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="estado" name="estado" value="<?= $row[4] ?>" required>
                                                </div>
