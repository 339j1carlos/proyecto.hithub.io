<?php
    class usernameModel{
        ...
        public function insertar($nombre, $direccion, $teléfono, $correo){
            $statement = $this->PDO->prepare("INSERT INTO nombre_de_la_tabla (nombre, direccion, telefono, correo) VALUES (:nombre, :direccion, :telefono, :correo)");
